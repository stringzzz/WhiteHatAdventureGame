#   WHAG, White Hat Adventure Game, a hacking simulation (BETA Version)
...
#WHAG (White Hat Adventure Game) BETA Version
#By stringzzz, Ghostwarez Co.
#Date complete: 01-27-2024
							...
							if (user_input == "//quit"):
								...
								if (trust <= 0):
									...
									if re.search(r"(hello|hi|what is up|(what is|what's) up|sup|(what is|what's) cracking|(what is|what's) going on)$", user_input):
										...
										if re.match(r"what (is |are )(your pet's names|the name(s)? of your pet(s)?)", user_input):
								...
								if (trust <= 0):
									...
									if re.search(r"(hello|hi|what is up|(what is|what's) up|sup|(what is|what's) cracking|(what is|what's) going on)$", user_input):
										...
										if (interestMatch):
											...
											if re.match(r"what (is |are )(your (pet's|cat's) names|the name(s)? of your (pet(s)?|cat(s)?))", user_input):
												rnum1 = random.randint(0, len(currentCats) - 1)
												rnum2 = rnum1
												while(rnum2 == rnum1):
													rnum2 = random.randint(0, len(currentCats) - 1)
										...
										for name in currentCats:
											if (name.lower() == word):
												interestMatch = True
										if (nameMatch):
											print("CrazyCatLady853: " + name + catTypes[name] + " I love them!")
											trust += 1
										else:
											for name in pastCats:
												if (name.lower() == word):
												...
												if (nameMatch):
													if (trust >= 7):
														print("CrazyCatLady853: " + name + catTypes[name] + " I miss them :'(")
													else:
								...
								if (trust <= 0):
									...
									if re.search(r"(hello|hi|what is up|(what is|what's) up|sup|(what is|what's) cracking|(what is|what's) going on)$", user_input):
										...
										if (trust >= 6):
											...
											print("monkeystinks52: I really love " + interestDict[privateInterests[rnum1].lower()] + " " + random.choice(privateInterests) + "!")
										else:	
									...
									elif re.search(r"(.*) is (cool|fun|awesome|great|good|nice)", user_input):
										m1 = re.match(r"(.*) is (cool|fun|awesome|great|good|nice)", user_input)
										word = m1.group(1)
										...
										for interest in openInterests:
											if (interest.lower() == word):
												...
												interestMatch = True
										if (interestMatch):
											print("monkeystinks52: Yes, " + word + " is " + description)
											trust += 1
										else:
											for interest in privateInterests:
												if (interest.lower() == word):
							...
							if (user_input == "//quit"):
								...
								if (trust <= 0):
									...
									if re.search(r"(hello|hi|what is up|(what is|what's) up|sup|(what is|what's) cracking|(what is|what's) going on)$", user_input):
										...
										if (username == "friendsforever28"):
											rnum1 = random.randint(0, len(openInterests_jb) - 1)
											print("johnnyboy082: I really love " + interestDict[openInterests_jb[rnum1].lower()] + " " + random.choice(openInterests_jb) + ", but you already know that lol")
										else:
										...
										if (interestMatch):
											if (username == "friendsforever28"):
												print("johnnyboy082: Hah " + word + " is definitely " + description)
												trust += 1
											else:
								...
								if (username == "friendsforever28"):
									...
									if re.search(r"(hello|hi|what is up|(what is|what's) up|sup|(what is|what's) cracking|(what is|what's) going on)$", user_input):
										...
										if (random.randint(0, 2) == 1):
											...
											rnum1 = random.randint(0, len(openInterests_ff) - 1)
											print("friendsforever28: I really love " + interestDict[openInterests_ff[rnum1].lower()] + " " + random.choice(openInterests_ff) + ", what about you?")
									elif re.search(r"what do you (like to do|do for fun|enjoy doing)", user_input):
										if (random.randint(0, 2) == 1):
										...
										for interest in openInterests_ff:
											if (interest.lower() == word):
												...
												interestMatch = True
										if (interestMatch):
											print("friendsforever28: I know, " + word + " is definitely " + description + ", right? :)")
											trust += 1
										else:
										...
										if (n == 0):
											rnum1 = random.randint(0, len(openInterests_ff) - 1)
											print("friendsforever28: I think I'll " + interestDict[openInterests_ff[rnum1].lower()] + " " + openInterests_ff[rnum1] + " in a while, maybe?")		  
										elif (n == 1):
...
if (onLevel == 8):
	...
	while(user_input != "//quit"):
		...
		if (user_input == "//login"):
								...
								if (trust <= 0):
									...
									if re.search(r"(hello|hi|what is up|(what is|what's) up|sup|(what is|what's) cracking|(what is|what's) going on)$", user_input):
										...
										if (trust >= 9):
											...
											print("redeye36: I absolutely love " + interestDict[secretInterests[rnum1].lower()] + " " + random.choice(secretInterests) + ", it's excellent!")
										elif (trust >= 5 and trust < 9):
											rnum1 = random.randint(0, len(privateInterests) - 1)
											print("redeye36: I really like " + interestDict[privateInterests[rnum1].lower()] + " " + random.choice(privateInterests) + ", it's great")
										else:	
										...
										if (trust >= 9):
											...
											rnum1 = random.randint(0, len(privateInterests) - 1)
											print("redeye36: I like to often " + interestDict[privateInterests[rnum1].lower()] + " " + random.choice(privateInterests) + ", good times")
											trust += 1
										else: 
											rnum = random.randint(0, len(privateInterests) - 1)
										...
										for interest in openInterests:
											if (interest.lower() == word):
												...
												interestMatch = True
										if (interestMatch):
											print("redeye36: Agreed, " + word + " is sometimes " + description)
											trust += 1
										else:
											for interest in privateInterests:
												if (interest.lower() == word):
			...
			print("Invalid command!\n")
if (onLevel == 9):
	interestChoices = ["drama movies", "chess", "go", "anime", "arts and crafts", "cars", "cats", "characters", "jokes", "meat", "music", "dances", "TikTok", "games", "graphic design", "coffee", "recipes", "mystery books", "model cars", "model planes", "Warhammer", "Pokemon cards", "MTG", "Star Wars", "Star Trek", "code", "computers", "photographs", "scotch", "coins"]
									...
									if re.search(r"(hello|hi|what is up|(what is|what's) up|sup|(what is|what's) cracking|(what is|what's) going on)$", user_input):
										...
										if (trust >= 16):
											...
											if (random.randint(0, 2) == 1):
												...
												rnum1 = random.randint(0, len(secretInterests) - 1)
												print("TheBoss0: I totally love " + interestDict[secretInterests[rnum1].lower()] + " " + random.choice(secretInterests) + ", it's the best!")
										elif (trust >= 7 and trust < 13):
											rnum1 = random.randint(0, len(privateInterests) - 1)
											print("TheBoss0: I like " + interestDict[privateInterests[rnum1].lower()] + " " + random.choice(privateInterests) + " a lot")
										else:	
										...
										if (trust >= 16):
											...
											rnum1 = random.randint(0, len(privateInterests) - 1)
											print("TheBoss0: I sometimes like to " + interestDict[privateInterests[rnum1].lower()] + " " + random.choice(privateInterests) + ", it's pretty cool")
											trust += 1
										else: 
											rnum = random.randint(0, len(privateInterests) - 1)
										...
										for interest in openInterests:
											if (interest.lower() == word):
												...
												interestMatch = True
										if (interestMatch):
											print("TheBoss0: True, " + word + " is " + description + " sometimes")
											trust += 1
										else:
											for interest in privateInterests:
												if (interest.lower() == word):
